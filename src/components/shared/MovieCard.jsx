...
export default function MovieCard({
  ...
  return (
    ...
    <article
      className={`rounded-lg overflow-hidden cursor-pointer bg-[#1a1a26] group relative
                         ...
                         ${
                           variant === 'continue-watching'
                             ? 'flex-[0_0_309px] md:flex-[0_0_302px]'
                             : variant === 'wide'
                               ? 'flex-[0_0_280px]'
                               : 'flex-[0_0_200px]'
                         }`}
    >
      ...
      <div
        className={`w-full bg-gradient-to-br from-[#1a1a26] to-[#252540]
                        overflow-hidden ${
                          variant === 'continue-watching'
                            ? 'h-[151px] md:h-[162px]'
                            : variant === 'wide'
      ...
      >
        <div
          className="w-12 h-12 bg-white/95 text-black rounded-full flex items-center justify-center
      ...
      <div className="p-3 pb-4">
        <h3 className="text-sm font-bold text-[#f1f0f5] truncate mb-1">
          {title}
        </h3>
        ...
        {progress !== undefined && (
          <div className="h-[3px] bg-[#2a2a3d] rounded-full mt-2 overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-[#09147A] to-[#E7E3FCDE] rounded-full"
