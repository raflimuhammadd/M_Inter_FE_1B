...
export default function Hero({ title, description, rating, year, duration, genres, image, badgeText }) {
    ...
    <section className="relative h-screen min-h-[600px] flex items-end pb-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-10 w-full">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <Button variant="primary" size="lg" icon="play">Mulai</Button>
          <Button variant="secondary" size="lg" icon="info">Selengkapnya</Button>
