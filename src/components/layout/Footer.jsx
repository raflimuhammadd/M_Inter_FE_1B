      ...
      <div className="max-w-[1280px] mx-auto px-10">
        ...
        <div className="hidden md:grid grid-cols-[240px_1fr_1fr] gap-16 mb-12">
          ...
          <div>
            <a
              href="#"
              className="inline-flex items-center gap-2 font-black text-[1.125rem] tracking-tight text-[#f1f0f5]"
            >
              ...
              <span className="font-['Londrina_Solid',cursive] text-[3rem]">
                CHILL
              </span>
            </a>
            <p className="text-sm text-[#5c5a70] mt-3 leading-relaxed">
            ...
            <div className="grid grid-cols-4 gap-3">
              {GENRES.map((g) => (
                <a
                  key={g}
                  href="#"
                  className="text-sm text-[#9b99ab] hover:text-[#f1f0f5] transition-colors"
                >
                  {g}
                </a>
              ))}
        ...
        <div className="md:hidden flex flex-col gap-0">
          <div>
            <a href="#" className="inline-flex items-center gap-2 mb-4">
              ...
              />
              <span className="font-['Londrina_Solid',cursive] text-[1.75rem]">
                CHILL
              </span>
            </a>
            <p className="text-sm text-[#5c5a70] mb-6">
              @2026 Chill All Rights Reserved
            </p>
          </div>
          ...
          {genreOpen && (
            <div id="genre-menu" className="flex flex-col gap-3 py-4">
              {GENRES.map((g) => (
                <a key={g} href="#" className="text-sm text-[#9b99ab]">
                  {g}
                </a>
              ))}
            </div>
          ...
          {bantuanOpen && (
            <div id="genre-menu" className="flex flex-col gap-3 py-4">
              {BANTUAN.map((b) => (
                <a key={b} href="#" className="text-sm text-[#9b99ab]">
                  {b}
                </a>
              ))}
            </div>
