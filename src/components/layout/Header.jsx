...
const NAV_ITEMS = [
  ...
  { to: '/films', icon: 'film', label: 'Film' },
  { to: '/watch-list', icon: 'list', label: 'Daftar Saya' },
];
    ...
    >
      <div className="flex items-center justify-between w-full max-w-[1280px] mx-auto">
        ...
        <div className="flex items-center gap-6 min-w-0 flex-1">
          <Link
            to="/home"
            className="flex items-center gap-1 h-11 w-fit font-black text-[1.125rem] tracking-tight text-[#f1f0f5]"
          >
            ...
            <span className="hidden lg:inline font-['Londrina_Solid',cursive] text-[2.35rem]">
              CHILL
            </span>
          </Link>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            className="w-9 h-9 rounded-full border border-white/[0.08] bg-white/[0.02]
          ...
          >
            <span
              className={`block h-[2px] bg-[#f1f0f5] rounded transition-all duration-300 origin-center
                             ${isMobileNavOpen ? 'translate-y-[7px] rotate-45' : ''}`}
            />
            <span
              className={`block h-[2px] bg-[#f1f0f5] rounded transition-all duration-300
      ...
      {isMobileNavOpen && (
        <>
          ...
          />
          <nav
            className={`lg:hidden fixed top-16 left-4 right-4
